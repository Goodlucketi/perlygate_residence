...
<template>
    <section class="rooms mt-20 pt-16 md:pt-30 bg-slate-800">
        <div class="rooms-container w-11/12 md:mt-12 p-4 mx-auto">
            ...
            <div class="rooms-views md:my-16">
                ...
                <div class="room md:flex justify-center gap-5 flex-row-reverse items-center my-5">
                    ...
                    <div class="room-txt md:w-5/12 p-2" data-aos="fade-right" data-aos-duration="2000" data-aos-delay="300">
                        ...
                        <p class="p-2 mb-5 md:mb-10">The air-conditioned suite has 1 bedroom and 1 bathroom with a shower and slippers. The suite features a tea and coffee maker, a dining area, a wardrobe, a flat-screen TV, as well as pool views.</p>
                        <router-link to="/room_detail" class="rounded-full bg-orange-600 p-3 text-sm md:text-base md:p-4 text-white ">LEARN MORE ></router-link>
                ...
                <div class="room md:flex justify-center gap-5 items-center my-5">
                    ...
                    <div class="room-txt md:w-5/12 p-2" data-aos="fade-left" data-aos-duration="2000" data-aos-delay="300">
                        ...
                        <p class="p-2 mb-5 md:mb-10">Featuring free toiletries, this mini suite includes a private bathroom. The air-conditioned room features a flat-screen TV, a tea, and coffee maker, and a wardrobe.</p>
                        <router-link to="/room_detail" class="rounded-full bg-orange-600 p-3 text-sm md:text-base md:p-4 text-white ">LEARN MORE ></router-link>
                    </div>
                </div>
                ...
                <div class="room md:flex justify-center gap-5 flex-row-reverse items-center my-5">
                    ...
                    <div class="room-txt md:w-5/12 p-2" data-aos="fade-right" data-aos-duration="2000" data-aos-delay="300">
                        ...
                        <p class="p-2 mb-5 md:mb-10">Featuring free toiletries, this room includes a private bathroom. The air-conditioned room features a flat-screen TV, a tea, and coffee maker, and a wardrobe.</p>
                        <router-link to="/room_detail" class="rounded-full bg-orange-600 p-3 text-sm md:text-base md:p-4 text-white ">LEARN MORE ></router-link>
