    ...
    <nav class="w-11/12 mx-auto flex justify-between items-center gap-">
      ...
      <div class="links">
        <div class="contact flex items-center justify-start md:justify-end gap-3">
          <p class="text-white p-2"><a href="tel:+2347086680366" class="hover:underline"><FontAwesomeIcon :icon="faPhone" class="bg-slate-800 p-3 rounded-full md:border-0 md:p-0 md:bg-transparent"/> <span class="hidden md:inline">+2347086680366</span> </a></p>
          <BookBtn class=""/>
